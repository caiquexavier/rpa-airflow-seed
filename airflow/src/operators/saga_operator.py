...
# ============================================================================
# Pure Functions (reused from start_saga_operator)
# ============================================================================
...
class SagaOperator(BaseOperator):
    """
    Unified SAGA operator that can start or complete a SAGA.
    
    Args:
        action: Action to perform - "start" to create a new SAGA, "complete" to mark existing SAGA as completed
        rpa_key_id: RPA key identifier (required for "start" action)
    ...
    def __init__(
        ...
        **kwargs
        ...
        if action == "start" and not rpa_key_id:
            raise ValueError("rpa_key_id is required when action='start'")

    def execute(self, context: Context) -> Dict[str, Any]:
        """
        Execute SAGA operation based on action type.
        """
    ...
    def _execute_start(self, context: Context) -> Dict[str, Any]:
    ...
    def _execute_complete(self, context: Context) -> Dict[str, Any]:
        ...
        task_id = self.task_id or "complete_saga"
