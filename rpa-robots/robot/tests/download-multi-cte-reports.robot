...
Download Multi CTE Reports
    [Documentation]    Download Multi CTE reports (Excel and PDF) for Canhotos for each subfolder in aprovados directory.
...
Execute Download Process For Entry
    ...
    [Documentation]    Execute the complete download process: browser, login, navigate, select report, download. Browser closes immediately after clicking download buttons.
...
Download Reports For Doc Transportes
    ...
    [Documentation]    Download Excel and PDF reports for the given doc_transportes. Clicks download buttons and closes browser immediately without waiting for toast.
    Select Report Date
    Select Report
    Preview
    ...
    Generate PDF Report
    # Just click download, don't wait for toast - browser will close immediately
    Log    Download buttons clicked for doc_transportes ${doc_transportes}, closing browser    level=INFO
